...
```{r libraries, message=FALSE, tidy.opts=list(width.cutoff=80), tidy = TRUE}
...
activity_raw <- read_csv("https://www.opendata.nhs.scot/dataset/0e17f3fc-9429-48aa
                      -b1ba-2b7e55688253/resource/748e2065-b447-4b75-99bd-f17f26f3eae
                      f/download/hd_activitybyhbr.csv")
...
mortality_plot %>%
  ...
  kable(col.names = c("Sex", "Age Group", "Year", "Coronary Heart Disease",
                      "Heart Attack", "Heart Failure"),
        align = "llclll",
        caption = "Heart Disease Mortality in Scotland 2015-2019") %>%
