...
The majority of `kableExtra` functions will work in [both HTML and PDF knitted files](https://github.com/haozhu233/kableExtra#basic-usage). When using a PDF file, you need to use the argument `latex_options` instead as you are producing LaTeX tables. 
